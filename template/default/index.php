...
<style type="text/css"> 
.btns{background-color:#666;position: absolute; top:116px; right:30px; z-index:1000; opacity:0.6;}
...
<div class="header">
	<div class="logo lf"><span class="invisible">协同网络办公系统</span></div>
    <div class="rt-col">
    	<div class="tab_style white cut_line text-r">
        <?php
		get_realpic($_USER->id);
		?>
		<?php echo get_realname($_USER->id)?>  [<text id="_groupname_"><?php echo $_USER->groupname?></text>]<span>|</span><a href="login.php?do=logout">[退出]</a><img src="template/default/images/u_zx1.gif"> 聊天</a><span>|</span><a href="desk.php">桌面快捷方式</a>
        <!--<span>|</span><a href="javascript:;" onClick="show_config()">授权</a><span>|</span><a href="http://bbs.phpoa.cn/" target="_blank">帮助？</a>-->
 <ul id="Skin">
...
function wSize(){
	...
	var heights = strs[0]-90,Body = $('body');$('#rightMain').height(heights);   
...
//站点下拉菜单
$(function(){
	if($("#_groupname_").text() != '系统管理组' ){
		$("#_M58").css({display:'none'});
		};
