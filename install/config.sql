INSERT INTO PO_config (id, value, name) VALUES
(1, 'PHPOA办公系统', 'name'),
...
(15, '1', 'configflag'),
(16, '1', 'mobile1'),
(19, 'm.515158.com|down.515158.com|api.515158.com', 'oaurl'),
(20, '0', 'usernum'),
(21, 'V2012 v2.0.20131031', 'com_editionnum'),
(22, '2012-05-10 14:43:25', 'crmdate'),
(18, '0', 'configinfoview');
INSERT INTO PO_phone_channel (id, company, price, content, connection, remainsum, type, connectionid, pkey, username, password, toaid, date) VALUES
(1, 'PHPOA增值服务平台', '0.1', '短信发送成功率98%，发送速度即时发送!', '0#515158#http://service.winic.org/webservice/public/remoney.asp?uid=#01&pwd=#01#515158#http://service.winic.org/sys_port/gateway/?id=#01&pwd=#01&to=#01&content=#01&encode=#01&time=#01#515158#http://service.winic.org/sys_port/Gateway/mo2.asp?id=#01&pwd=#01', '0', '3', '1', '1', '', '', NULL, '2011-06-30 15:16:58');
INSERT INTO PO_plugin (id, title, company, version, date, `update`, type, filename) VALUES
(10001, '工作流', 'PHPOA', 'v3.0', NULL, NULL, '1', 'workclass'),
...
(10008, '公文系统', 'PHPOA', 'v3.0', NULL, NULL, '1', 'app'),
(10009, '档案系统', 'PHPOA', 'v2.0', NULL, NULL, '1', 'file'),
(10010, '项目管理', 'PHPOA', 'v2.0', NULL, NULL, '1', 'project'),
(10011, '薪资管理', 'PHPOA', 'v2.0', NULL, NULL, '1', 'wage'),
(10012, '手机版', 'PHPOA', 'v1.0', NULL, NULL, '1', 'm');
INSERT INTO PO_keytable (id, name, inputname, inputvalue, inputchecked, type, number, fatherid) VALUES
...
INSERT INTO PO_menu (menuid, menuname, menuurl, fatherid, menutype, menunum, menukey) VALUES
...
(21, '工作日志', 'admin.php?ac=blog&fileurl=workbench', '3', '2', 6, '0'),
...
INSERT INTO PO_office_type (oid, oname, otype, uid) VALUES
(54, '劳务合同', '14', '1'),
(55, '保密合同', '14', '1'),
(56, '其它', '14', '1'),
(57, '试用期', '15', '1'),
...
(72, '业绩奖励', '19', '1'),
(73, '奖金', '19', '1');
INSERT INTO PO_usergroup (id, groupname, purview, type) VALUES
