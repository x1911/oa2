...
版权所有 (C) 2009-2014，phpoa.cn 保留所有权利。

PHPOA办公系统(简称PHPOA)是由北京天生创想信息技术有限公司独立开发的基于PHP+MySQL的OA系统。PHPOA办公系统为开放式管理系统，免费供大家使用，学习，交流， 任何人都可以从互联网上免费下载，并可以在不违反本协议规定和非商业用途的前提下进行使用。
开发商：北京天生创想信息技术有限公司
官方网址： www.phpoa.cn
开发团队：PHPOA研发组
...
一、本授权协议适用且仅适用于PHPOA任何版本，PHPOA官方拥有对本授权协议的最终解释权和修改权。

二、协议许可的权利和限制
1、您可以在完全遵守本最终用户授权协议的基础上，将本软件应用于非商业用途，而不必支付软件版权授权费用，但我们也不承诺对个人用户提供任何形式的技术支持。
2、您可以在协议规定的约束和限制范围内修改PHPOA源代码或界面风格以适应您的系统要求。
...
3、请务必仔细阅读本授权协议，在您同意授权协议的全部条件后，即可继续PHPOA的安装。即：您一旦开始安装PHPOA，即被视为完全同意本授权协议的全部内容，如果出现纠纷，我们将根据相关法律和协议条款追究责任。
			</textarea></td>
		</tr>
		<tr>
			<td>
	...
	<?php elseif ( $step == 3 ) :?>
		...
		<tr>
			...
			<hr noshade="noshade" >
			<input type="hidden" name="dbprefix" value="PO_" class="input" />
	...
	<?php elseif ( $step == 4 ) :?>
		<tr><th colspan="2">第四步：设置管理员帐号<span style="font-size:14px; color:#999;">(正确的填写,可获取论坛更及时的后期服务!)</span><hr noshade="noshade" ></th></tr>
		<?php 
		...
		<tr>
			...
			<tr>
				...
				<td><input type="text" name="username" class="input" value="phpoa" /></td>
			</tr>	
			<tr>
	...
	<?php elseif ( $step == 6 ) :?>
		...
		<?php
			...
			$id=$db->insert_id();
			$db->query("INSERT INTO `PO_user_view` (`name`, `uid`) VALUES ('管理员','".$id."')");
			...
			$db->query("update ".DB_TABLEPRE."config set value='V2.0' where name='com_editionnum'");
			$userin=$name."(*)".$person."(*)".$phone."(*)".$tel."(*)".$mail."(*)".$blogurl."(*)官网";
...
<p id="copyright">Copyright &copy; 2009-2014  <a href="http://www.phpoa.cn" target="_blank">北京天生创想信息技术有限公司</a> All Rights Reserved.</p>
<div style="display:none;">
<script type="text/javascript">
var _bdhmProtocol = (("https:" == document.location.protocol) ? " https://" : " http://");
document.write(unescape("%3Cscript src=" + _bdhmProtocol + "hm.baidu.com/h.js%3F569322d6eae0bb12f168b4701cc26f09 type=text/javascript %3E%3C/script%3E"));
