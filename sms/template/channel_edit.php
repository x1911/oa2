...
<table width="90%" border="0" align="center" cellpadding="3" cellspacing="0" class="small">
  <tr>
	...
	<a href="http://bbs.phpoa.cn/" target="_blank" style="font-size:12px;">使用遇到问题？</a></span>
    </td>
  </tr>
</table>
...
<table class="TableBlock" border="0" width="90%" align="center" style="border-bottom:#4686c6 solid 0px;">
 <tr>
      ...
      <td class="TableData" style="font-size:18px;font-weight:bold; color:#006600; line-height:150%;">如果您还没有开通短信平台的用户名和密码，请登录官方网站开通<br>开通后将官网提供的账号和密码输入后并保存，具体咨费以官网为主,详情请致电15868224111<br>
	  官方网址：<a href="http://www.phpoa.cn" target="_blank">http://www.phpoa.cn</a>	 接口申请：<a href="http://bbs.phpoa.cn" target="_blank">http://bbs.phpoa.cn</a>	  </td>
    </tr>
 <tr>
