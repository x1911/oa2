			...
			<div id="J-advanced-filter-option" class="">
				<div class="record-search-time fn-clear">
					<div class="ui-form-item ui-form-item-time">
						...
						<div class="ui-form-content">
						<input type="text" value="<?php echo $vstartdate?>"  class="ui-input i-date" readonly  onClick="WdatePicker();" name='vstartdate' > - <input type="text" value="<?php echo $venddate?>"  class="ui-input i-date" readonly  onClick="WdatePicker();" name='venddate' >
						</div>
						...
						<table id="tradeRecordsIndex" class="ui-table">
							...
							<thead>
								<tr>
									...
									<th class="title" style="min-width:100px;">计划主题</th>
