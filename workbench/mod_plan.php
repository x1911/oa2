...
/*
	...
	$Id: mod_plan 1209087 2014-01-08 08:58:28Z phpoa $
*/
	...
	if($_POST['view']!=''){
		...
		if($id!=''){
			...
			if(getGP('sms_info_box_person','P')!=''){
				$content='计划：<b>'.$title.'</b> 需要执行!<a href="admin.php?ac='.$ac.'&fileurl='.$fileurl.'&do=views&id='.$id.'">点击查看>></a>';
			...
			if(getGP('sms_info_box_participation','P')!=''){
				$content='计划：<b>'.$title.'</b> 需要您参与!<a href="admin.php?ac='.$ac.'&fileurl='.$fileurl.'&do=views&id='.$id.'">点击查看>></a>';
